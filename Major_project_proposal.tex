...
\begin{table}[htbp]
    \centering
    \caption{SAM Benchmark across varying lighting conditions.}
    \label{tab:sam_benchmark}
    \begin{tabular}{lcccc}
        \toprule
        \textbf{Intensity (Lux)} & \textbf{Avg Confidence} & \textbf{Avg IoU} & \textbf{Stability Rate (AP $\ge$ 0.5)} & \textbf{Latency (s)} \\
        \midrule
        250 & 0.649 & 0.906 & 0.96 & 0.50 \\
        200 & 0.655 & 0.925 & 0.96 & 0.50 \\
        70  & 0.648 & 0.820 & 0.86 & 0.50 \\
