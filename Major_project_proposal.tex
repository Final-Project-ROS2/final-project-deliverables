...
To improve perception reliability, a uniform acrylic plate is placed within the camera’s field of view to act as a controlled visual background. This reduces the impact of environmental noise and improves the robustness of object detection and segmentation.

In addition, structured cable management is implemented using a custom mounting solution to secure wiring and prevent interference with the robot’s motion. These design considerations improve system stability and ensure safe operation within the robot workspace.
