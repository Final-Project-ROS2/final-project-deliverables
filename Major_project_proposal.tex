...
In summary, future work will prioritize enhancing the determinism and correctness of the symbolic planning pipeline, completing the integration of the vision system, and extending task complexity in experimental evaluations. These improvements will move the system toward a more autonomous and perceptually aware planning framework capable of handling complex, open-ended tasks in dynamic environments.
