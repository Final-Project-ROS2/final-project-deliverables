...
\midrule
1 & 58.842 & 57.615 & 58.260 & 1.688 \\
2 & 56.860 & 56.437 & 56.060 & 1.522 \\
3 & 46.282 & 49.2225 & 44.468 & 3.608 \\
4 & 49.240 & 50.8267 & 50.250 & 1.706 \\
5 & 58.750 & 59.744 & 59.648 & 1.204 \\
6 & 62.605 & 62.595 & 62.762 & 1.438 \\
\midrule
\textbf{Average} & \textbf{55.430} & \textbf{56.000} & \textbf{55.240} & \textbf{1.860} \\
\bottomrule
\end{tabular}
\end{table}
...
Execution Time (s) & 55.430 & \textcolor{red!70!black}{\textbf{56.000}} & 55.240 & \textcolor{green!50!black}{\textbf{1.860}} \\
...
In terms of efficiency, LLM-Direct has the lowest average planning time among automated methods (6.460\,s), followed by IR-Based PDDL (6.950\,s) and PDDL-Direct (7.710\,s), as shown in Table~\ref{tab:overall-planning-time}. However, execution time remains similar across all automated methods (approximately 55--56\,s), as shown in Table~\ref{tab:overall-execution-time}, indicating that physical robot execution dominates end-to-end latency more than planner computation. The additional planning overhead of IR-Based PDDL relative to LLM-Direct is modest (approximately 0.49\,s) while providing a substantial reliability gain.
